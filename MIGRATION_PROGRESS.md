...
- [ ] P2.1.1 更新 `requirements.txt` (添加 Playwright)
- [ ] P2.1.2 安装 Playwright 浏览器

### 2.2 爬虫核心 (0/20)

- [ ] P2.2.1 创建 `src/scraper/__init__.py`
- [ ] P2.2.2 实现 `Archiver` 类
  - [ ] P2.2.2.1 `__init__()` 初始化
  - [ ] P2.2.2.2 `archive_authors()` 主方法
  - [ ] P2.2.2.3 `_collect_posts()` 收集链接
  - [ ] P2.2.2.4 `_archive_post()` 归档单帖
  - [ ] P2.2.2.5 `_check_exists()` 增量检查
- [ ] P2.2.3 实现 `Extractor` 类
  - [ ] P2.2.3.1 `extract_title()` 提取标题
  - [ ] P2.2.3.2 `extract_author()` 提取作者
  - [ ] P2.2.3.3 `extract_date()` 提取日期
  - [ ] P2.2.3.4 `extract_content()` 提取内容
  - [ ] P2.2.3.5 `extract_media()` 提取媒体
  - [ ] P2.2.3.6 `clean_html()` 清理 HTML
- [ ] P2.2.4 实现 `Downloader` 类
  - [ ] P2.2.4.1 `download_image()` 下载图片
  - [ ] P2.2.4.2 `download_video()` 下载视频
  - [ ] P2.2.4.3 `download_batch()` 批量下载
  - [ ] P2.2.4.4 异步并发实现
- [ ] P2.2.5 实现 `Follower` 类
  - [ ] P2.2.5.1 `follow()` 关注作者
  - [ ] P2.2.5.2 提取作者逻辑
  - [ ] P2.2.5.3 触发首次归档
- [ ] P2.2.6 Markdown 生成器
- [ ] P2.2.7 文件名安全化处理
